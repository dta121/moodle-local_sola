...
$string['settings:mainpage'] = 'SOLA Settings';
$string['settingsgroup:general'] = 'General';
$string['settingsgroup:search_ai'] = 'Search & AI';
$string['settingsgroup:moderation'] = 'Moderation';
$string['settingsgroup:maintenance'] = 'Maintenance';
$string['settings:llm_management_title'] = 'LLM Provider Management';
$string['settings:llm_management_heading'] = 'LLM Provider Management';
$string['settings:llm_management_desc'] = 'Configure API credentials, base URLs, supported models, and system-wide fallback defaults for each LLM provider.';
$string['settings:llm_management_button'] = 'Open LLM Provider Management';
$string['settings:llm_default_provider'] = 'System Default Provider';
$string['settings:llm_default_provider_desc'] = 'Primary provider SOLA should use when no student-specific model selection is active.';
$string['settings:llm_default_model'] = 'System Default Model';
$string['settings:llm_default_model_desc'] = 'Default model used with the system default provider. Only active provider/model combinations appear here.';
$string['settings:llm_default_model_none'] = 'No configured models yet';
$string['settings:llm_provider_heading_desc'] = 'Default Base URL: {$a->baseurl}<br>API Key: {$a->apikey}';
$string['settings:llm_provider_apikey_desc'] = 'Save the API key for this provider. Leave blank to keep the provider inactive. Ollama can be left blank.';
$string['settings:llm_provider_baseurl_desc'] = 'Base URL for this provider. Leave the default in place unless you need a custom endpoint.';
$string['settings:llm_provider_models'] = 'Supported Models';
$string['settings:llm_provider_models_desc'] = 'Comma-separated list of models students and admins can use for this provider.';
$string['settings:llm_provider_requires_apikey'] = 'Required';
$string['settings:llm_provider_optional_apikey'] = 'Optional';
$string['settings:llm_provider_baseurl_blank'] = 'Leave blank until you are ready to configure this provider.';
$string['settings:provider_heading_desc_main'] = 'Configure conversation behavior here. Manage API keys, base URLs, supported models, and system defaults in LLM Provider Management.';
$string['settings:allow_student_model_switching'] = 'Allow students to switch models';
$string['settings:allow_student_model_switching_desc'] = 'If enabled, students can choose from the currently active provider/model combinations inside the chat settings panel.';
$string['settings:starter_icon_color'] = 'Starter icon color';
$string['settings:starter_icon_color_desc'] = 'Color used for the conversation starter icons in the chat drawer.';
$string['error'] = '{$a}';
...
$string['settings:model_desc'] = 'The model to use. Default depends on provider (e.g. claude-haiku-4-5-20251001, gpt-4o-mini, llama3, MiniMax-Text-01).';
...
$string['settings:avatar_color_desc'] = 'Border color of the floating avatar button. Use a hex value, e.g. #173140.';
...
$string['settings:hide_on_quiz_for_students_desc'] = 'When enabled, SOLA is not shown to users in the student role while they are on Moodle quiz module pages. Administrators and academic support staff can still see it.';
$string['settings:hide_on_quiz_for_staff'] = 'Hide SOLA on quiz pages for administrators and academic support';
$string['settings:hide_on_quiz_for_staff_desc'] = 'When enabled, SOLA is also hidden on Moodle quiz module pages for administrators, managers, teachers, and academic support users. Enable this together with the student setting to hide SOLA for everyone on quiz pages.';
...
$string['coursesettings:enabled_desc'] = 'When enabled, the settings below override the global conversation behavior for this course only. Provider credentials and model catalogs stay in the global LLM Provider Management page.';
...
$string['coursesettings:override_hierarchy_desc'] = 'Global plugin settings are the default for every course. If "Enable course overrides" is off, this page has no effect. When it is on, the course can override the system prompt and temperature only; provider credentials, base URLs, and model catalogs stay global. Conversation starter toggles and English Lock apply only to this course, while voice-related starters still depend on the required global TTS or Realtime settings being available.';
...
$string['coursesettings:english_lock_desc'] = 'Force SOLA to always respond in English for this course, regardless of the student\'s language preference. Ideal for English language learning courses where students should practice reading and writing in English.';
$string['coursesettings:english_lock_enable'] = 'Always respond in English for this course';
...
$string['updates:title'] = 'Plugin Updates';
$string['updates:current_version'] = 'Current version';
$string['updates:latest_version'] = 'Latest GitHub release';
$string['updates:status'] = 'Update status';
$string['updates:status_current'] = 'Up to date';
$string['updates:status_available'] = 'Update available';
$string['updates:status_unknown'] = 'Unable to check';
$string['updates:published'] = 'Published';
$string['updates:changelog'] = 'Release changelog';
$string['updates:no_changelog'] = 'No changelog text was provided for this release.';
$string['updates:install'] = 'Install update';
$string['updates:install_confirm'] = 'Download and install the latest GitHub release now? SOLA will create a backup before swapping plugin files.';
$string['updates:no_update'] = 'You are already on the latest available release.';
$string['updates:view_release'] = 'View release on GitHub';
$string['updates:backup_note'] = 'The current plugin files will be moved to a timestamped backup folder before the new release is activated.';
$string['updates:last_backup'] = 'Most recent backup folder: {$a}';
$string['updates:install_success'] = 'SOLA plugin files were updated from {$a->old} to {$a->new}. Complete the Moodle upgrade to apply the new version.';
$string['updates:error_check'] = 'Unable to check the latest GitHub release.';
$string['updates:error_download'] = 'Unable to download the GitHub release package.';
$string['updates:error_extract'] = 'Unable to extract the downloaded update package.';
$string['updates:error_package'] = 'The downloaded update package did not contain a valid SOLA plugin.';
$string['updates:error_stage'] = 'Unable to stage the extracted update package for installation.';
$string['updates:error_backup'] = 'Unable to move the current plugin into the backup location.';
$string['updates:error_swap'] = 'Unable to swap the staged plugin into place.';
$string['updates:error_network'] = 'GitHub request failed';
$string['updates:error_redirects'] = 'Too many redirects were encountered while contacting GitHub.';
$string['updates:error_url'] = 'Only HTTPS GitHub URLs are allowed for self-updates.';
$string['updates:error_directory'] = 'Unable to create a temporary update directory';
$string['updates:unknown'] = 'Unknown';
$string['integrity:title'] = 'Integrity Monitoring';
$string['integrity:run_now'] = 'Run now';
$string['integrity:run_success'] = 'Integrity checks completed.';
$string['integrity:no_results'] = 'No integrity results are stored yet. Use "Run now" or wait for the daily scheduled task.';
$string['integrity:last_run'] = 'Last run';
$string['integrity:status'] = 'Status';
$string['integrity:passed'] = 'Passed';
$string['integrity:failed'] = 'Failed';
$string['integrity:warnings'] = 'Warnings';
$string['integrity:results'] = 'Check results';
$string['integrity:check'] = 'Check';
$string['integrity:details'] = 'Details';
$string['integrity:status_pass'] = 'Pass';
$string['integrity:status_fail'] = 'Fail';
$string['integrity:status_warn'] = 'Warn';
$string['integrity:alert_email'] = 'Failure alerts will be sent to: {$a}';
$string['integrity:email_subject'] = 'SOLA integrity check failed on {$a}';
...
$string['chat:mode_nav'] = 'Choose how you want to use SOLA';
$string['chat:mode_chat'] = 'Chat';
$string['chat:mode_voice'] = 'Voice Chat';
$string['chat:mode_history'] = 'History';
$string['chat:voice_title'] = 'Talk through the lesson';
$string['chat:voice_copy'] = 'Start a voice conversation about this page or another course topic. Your transcript will still show up in chat.';
$string['chat:voice_ready'] = 'Ready when you are.';
$string['chat:voice_start'] = 'Start voice chat';
$string['chat:history_title'] = 'Recent conversation';
$string['chat:history_subtitle'] = 'Review your latest chat messages for this course, then jump back in when you are ready.';
$string['chat:history_empty'] = 'Your conversation history will appear here after you chat with SOLA.';
...
$string['settings:whatsapp_api_url_desc'] = 'The API endpoint for sending WhatsApp messages. Generic webhooks should accept POST with a JSON body containing "to", "from", and "body". Twilio is also supported when you provide a Twilio Messages API URL such as /Accounts/{AccountSid}/Messages.json.';
$string['settings:whatsapp_api_token'] = 'WhatsApp API Token';
$string['settings:whatsapp_api_token_desc'] = 'Authentication token for the WhatsApp API. For Twilio, enter the account Auth Token.';
$string['settings:whatsapp_from_number'] = 'WhatsApp Sender Number';
$string['settings:whatsapp_from_number_desc'] = 'The phone number to send WhatsApp messages from (with country code, e.g. +14155238886). For Twilio, enter your approved WhatsApp sender number or sandbox number; SOLA will add the whatsapp: prefix automatically.';
...
$string['settings:updates_heading'] = 'Plugin Updates';
$string['settings:updates_heading_desc'] = 'Check GitHub for new SOLA releases and install updates with a backup/rollback workflow from the admin page below.';
$string['settings:github_token'] = 'GitHub Token';
$string['settings:github_token_desc'] = 'Optional GitHub personal access token. This raises API rate limits when checking releases and downloading update packages.';
$string['settings:integrity_heading'] = 'Integrity Monitoring';
$string['settings:integrity_heading_desc'] = 'Run automated daily health checks across key SOLA files, settings, templates, and database objects. Email alerts are sent only when failures are detected.';
$string['settings:integrity_enabled'] = 'Enable daily integrity checks';
$string['settings:integrity_enabled_desc'] = 'When enabled, SOLA runs automated integrity checks every day at 3:00 AM server time.';
$string['settings:integrity_email'] = 'Integrity alert email';
$string['settings:integrity_email_desc'] = 'Optional email address for integrity failure alerts. Leave blank to send alerts to the site administrator.';
...
$string['whatsapptest:config_notice'] = 'This page uses the saved WhatsApp API URL, token, and sender number from the Study Planning & Reminders settings page. Twilio Messages API URLs are detected automatically and sent using Twilio Basic authentication.';
...
$string['whatsapptest:recipient_desc'] = 'Enter the destination number in the format required by your WhatsApp provider, usually including the country code. For Twilio, you can enter either +15551234567 or whatsapp:+15551234567.';
...
$string['ragadmin:reindexall_desc'] = 'Runs incremental indexing on all visible courses. Only new or changed content is re-embedded.';
$string['ragadmin:reindexall_confirm'] = 'This will call the embedding API for all new or changed content across all visible courses. Continue?';
...
$string['ragadmin:stat_active_courses'] = 'Visible courses';
...
$string['settings:realtime_voice_desc']   = 'Voice used for Voice Mode and the TTS speak button. SOLA will automatically use a compatible OpenAI voice when Realtime and speech endpoint voice catalogs differ.';
$string['settings:debug_heading']         = 'Debugging';
$string['settings:debug_heading_desc']    = 'Optional diagnostics to help administrators verify what page/context data SOLA is receiving during chats.';
$string['settings:context_debug_enabled'] = 'Enable chat context debug inspector';
$string['settings:context_debug_enabled_desc'] = 'Shows an admin-only debug panel inside SOLA for users with course manage access. The panel displays the current page metadata captured by the widget, the last request sent to the chat endpoint, and the prompt-side page context appended for the model. Students never see this panel.';
$string['chat:debug_context']             = 'Context debug';
$string['chat:debug_context_toggle']      = 'Toggle context debug panel';
$string['chat:debug_context_copy']        = 'Copy debug snapshot';
$string['chat:debug_context_browser']     = 'Browser snapshot';
$string['chat:debug_context_request']     = 'Last request';
$string['chat:debug_context_prompt']      = 'Prompt view';
$string['task:run_integrity_checks']      = 'Run daily SOLA integrity checks';
